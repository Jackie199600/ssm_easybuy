  ...
  <div class="sou">
        ...
        <span class="fr">
          <c:if test="${sessionScope.user==null}">
            <span class="fl">你好，请<a href="index.jsp" style="color:#ff4e00;">登录</a>&nbsp;<a href="register.jsp" style="color:#ff4e00;">免费注册</a>&nbsp;&nbsp;</span>
          </c:if>
          <c:if test="${sessionScope.user!=null}">
            <span class="fl"><a href="/userInfo.jsp">欢迎回来！${sessionScope.user.username}</a>&nbsp;|&nbsp;<a href="/order/findByUser">我的订单</a>&nbsp;</span>
          </c:if>
           ...
           <c:if test="${sessionScope.user!=null}">
             <span class="fl">|&nbsp;<a href="/user/logout" >注销</a></span>
          </c:if>
        </span>
  </div>
</div>
